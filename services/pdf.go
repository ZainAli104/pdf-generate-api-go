...
//		pdf.CellFormat(70, 10, str, "1", 0, "C", true, 0, "")
...
func (p *PdfService) GeneratePdf() ([]byte, error) {
	...
	pdf.Ln(20) // Some space before the Attendance Data
	...
	for _, a := range attendance {
		pdf.CellFormat(70, 10, a.PunchTime.Format("2006-01-02 15:04:05"), "1", 0, "L", false, 0, "")
		pdf.CellFormat(70, 10, helpers.PunchToString(a.Punch), "1", 0, "L", false, 0, "")
		pdf.CellFormat(70, 10, helpers.AttendanceStatusToString(a.Status), "1", 0, "L", false, 0, "")
		pdf.Ln(-1)
	}
